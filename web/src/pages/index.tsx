...
import usersAvatarExmapleImg from "../assets/users-avatar-examples.png";
    ...
    <div className="max-w-[1124px] h-screen mx-auto grid grid-cols-2 gap-28 items-center">
      <main>
        ...
        <div className="mt-10 flex items-center gap-2">
          <Image src={usersAvatarExmapleImg} alt="" />
        ...
        <form onSubmit={createPool} className="mt-10 flex gap-2">
          <input
            ...
            value={poolTitle}
          />
          <button className="bg-yellow-500 px-6 py-4 rounded font-bold text-sm uppercase">
            criar meu bolão
          </button>
        </form>
